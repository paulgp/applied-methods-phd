...
\item Benjamin T. Miller and Peter M. Aronow, {\textit{Foundations of Agnostic Statistics}}
...
\item \underline{Causality, Statistics, and Economics}
  ...
  \item Potential Outcomes and Directed Acyclic Graphs
    \begin{itemize}
    \item Chapter 7, Miller and Aronow
  ...
  \item Randomization: Experiments, Non-experimental, and Fisher
    ...
    \item ``Clustering, Spatial Correlations, and Randomization Inference'', Barrios, Diamond, Imbens and Kolesar (2012)
    \end{itemize}
...
\item \underline{Linear Regression}
  ...
  \item Regularized linear regression
    ...
    \item ``Valid Post-Selection Inference in High-Dimensional Approximately Sparse Quantile Regression Models'' Belloni, Chernozhukov and Kato (2018)
    \end{itemize}
  \end{enumerate}
\item \underline{Maximum Likelihood, Bayesian Methods, Generalized Method of Moments, and Minimum Distance}
  \begin{enumerate}
...
\item  \underline{Canonical Research Designs}
  ...
  \item Judge IV
    \begin{itemize}
    \item ``Consumer bankruptcy and financial health'' Dobbie, Goldsmith-Pinkham and Song (2016)
    ...
    \end{itemize}
  \item Regression Discontinuity and Regression Kink Design
    \begin{itemize}
...
\item \underline{Machine Learning}
  ...
  \item Supervised Machine Learning
    ...
    \item ``Estimation and Inference of Heterogeneous Treatment Effects using Random Forests'' Athey and Wager (2019)
    \item 
    \end{itemize}
...
\begin{itemize}
\item Regular attendance is not required, due to Covid circumstances, but it preferred. 
\end{itemize}
