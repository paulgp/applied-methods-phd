...
\textbf{Email:} &  \href{mailto:paul.goldsmith-pinkham@yale.edu}{paul.goldsmith-pinkham@yale.edu} & & & \textbf{Location:} & Usually Evans Hall 2430, see Canvas for details
\end{tabular}
\end{minipage}
\rule{6.5in}{0.4pt}
\end{center}
...
You are also very welcome (and encouraged) to use any and all large language model help when working on the problem sets! 
...
\item \underline{Causality, Statistics, and Economics}
  ...
  \item Class 1: Potential Outcomes and Directed Acyclic Graphs
    ...
    \item ``Models, Measurement, and the Language of Empirical Economics'', Haile \url{https://s3.amazonaws.com/file.paulgp.com/30d/haile.pdf
    }
    \item ``Statistics and Causal Inference'', Holland 1986
    \item ``Potential Outcome and Directed Acyclic Graph Approaches to Causality: Relevance for Empirical Practice in Economics'', Imbens (2020)
